 ...
 */
public class AdminClassroom extends Fragment {

    FloatingActionButton fb;

    ClassroomAdapter adapter; // Create Object of the Adapter class
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_admin_classroom, container, false);
        ...
        Query mbase = FirebaseDatabase.getInstance().getReference().child("Classroom").orderByChild("type").equalTo("classroom");
        ...
        fb=(FloatingActionButton)v.findViewById(R.id.classroomadd);
        fb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(v.getContext(), AddClassroom.class);
