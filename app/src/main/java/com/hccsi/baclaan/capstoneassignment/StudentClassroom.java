...
public class StudentClassroom extends Fragment {
    ...
    StudentClassroomAdapter adapter; // Create Object of the Adapter class
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_student_classroom, container, false);
        ...
        Query mbase = FirebaseDatabase.getInstance().getReference().child("Classroom").orderByChild(save);
        ...
        adapter = new StudentClassroomAdapter(options);
