...
public class AdminTeach extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_admin_teach, container, false);
        ...
        Query mbase = FirebaseDatabase.getInstance().getReference().child("Users").orderByChild("status").equalTo("teacher");
        ...
        FirebaseRecyclerOptions<TeacherModel> options
                ...
                .setQuery(mbase, TeacherModel.class)
                .build();
...
// Connecting object of required Adapter class to
        ...
        fb=(FloatingActionButton)v.findViewById(R.id.fadd);
        fb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(v.getContext(), AddTeacher.class);
